...
impl From<ActixHttpError> for CustomError{
    ...
    fn from(error: DieselError) -> CustomError{
        match error {
            ...
            DieselError::NotFound => {
                CustomError::new(404, "the user record was not found".to_string())
            }
            err => CustomError::new(500, format!("Other unknown Diesel Error:{}", err)),
